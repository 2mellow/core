...
$pages = $salesbarn->get_list(get_page_number(), false, "/admin/".$plugin."/");
...
<div class="row">
    ...
    <table class="table table-bordered table-condensed vert-middle" style="margin-bottom:10px;">
        ...
        <tr>
            ...
            <td width="120"><strong>Image</strong></td>
            <td><strong>Name</strong></td>
            <td width="170"><strong>Date Created</strong></td>
        </tr>
        <?
        if($pages){
            foreach($pages as $v){
                ...
                <tr>
                    ...
                    <td><a href="/admin/<?=$plugin?>/manage/<?=$v->id?>/"><img src="/uploads/salesbarn/thumb-<?=$v->image?>" /></a></td>
                    <td><a href="/admin/<?=$plugin?>/manage/<?=$v->id?>/"><?=$v->horsename?></a></td>

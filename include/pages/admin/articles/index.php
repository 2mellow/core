...
$pages = $articles->get_list(get_page_number(), false, "/admin/".$plugin."/");
...
<div class="row" style="padding:10px 0px;">
	<div class="col-sm-4">
    	<div class="form-group" style="margin-bottom:5px;">
    		<input type="text" name="search" id="search" class="form-control" placeholder="Search for an article" value="">
        </div>
    </div>
